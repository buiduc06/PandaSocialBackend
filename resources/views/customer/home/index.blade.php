	...
	<div class="top-grids">
		...
		<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
			<div class="resent-grid-img recommended-grid-img">
				<a href="single.html"><img src="/assets/customer/images/t1.jpg" alt="" /></a>
				<div class="time">
					<p>3:04</p>
				</div>
				<div class="clck">
		...
		<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
			<div class="resent-grid-img recommended-grid-img">
				<a href="single.html"><img src="/assets/customer/images/t2.jpg" alt="" /></a>
				<div class="time">
					<p>7:23</p>
				</div>
				<div class="clck">
		...
		<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
			<div class="resent-grid-img recommended-grid-img">
				<a href="single.html"><img src="/assets/customer/images/t3.jpg" alt="" /></a>
				<div class="time">
					<p>4:04</p>
				</div>
				<div class="clck">
