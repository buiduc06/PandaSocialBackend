                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand mt-3" href="#">
                        ...
                        <b class="logo-icon">
                            ...
                            <img src="/images/logo_2.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text ml-3" style="color: white;font-family: Arial;">
                            <h5 class="text-white">PANDA <br><small>Social Network</small>
                            </h5>
