            ...
            <div class="card card-body">
                ...
                <form class="form-horizontal m-t-30" action="{{route('admin.course.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="file-loading">
                                <input id="file-1" type="file" multiple class="file" name="video[]" data-overwrite-initial="false" data-min-file-count="1" data-theme="fas">
                            </div>
                        </div>
                        <hr>
                        ...
                        @if(count($errors) > 0)
                        <span class="help-block text-danger"><small>{{$errors->first('video')}}</small></span>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="file-loading">
                                <input id="file-2" type="file" class="file" name="image" data-overwrite-initial="false" data-min-file-count="0" data-theme="fas">
                            </div>
                        </div>
                        <hr>

                        @if(count($errors) > 0)
                        <span class="help-block text-danger"><small>{{$errors->first('image')}}</small></span>
                        @endif
                    </div>
