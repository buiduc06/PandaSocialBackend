            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <h5 class="font-medium m-b-20 mt-2 pt-2">Sign In to Admin</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" id="loginform" action="{{route('admin.store')}}" method="POST">
                            	{{csrf_field()}}
                                 @if ($errors->has('email'))
                ...
                {{-- <div id="recoverform">
                    ...
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form class="col-12" action="https://wrappixel.com/demos/admin-templates/xtreme-admin/html/light-sidebar/index.html">
                            <!-- email -->
                            <div class="form-group row">
                                <div class="col-12">
